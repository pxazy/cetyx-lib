...
function Library:SetLabelAlignment(Alignment)
    -- Alignment: 'Left', 'Center', 'Right'
    Library.LabelAlignment = Alignment or 'Left'
    ...
    for _, Data in next, Library.Registry do
        ...
        if inst:IsA('TextLabel') and inst.Parent and inst.Parent:IsA('Frame') then
            pcall(function() inst.TextXAlignment = xAlign end)
        end
    end
end
...
ToggleButton.Position = UDim2.fromOffset(100, 100)
ToggleButton.BackgroundColor3 = Library.AccentColor
ToggleButton.BorderSizePixel = 0
ToggleButton.Parent = Library.ScreenGui

local UICorner = Instance.new("UICorner", ToggleButton)
UICorner.CornerRadius = UDim.new(0, 6)

Library:MakeDraggable(ToggleButton, 1000)
...
Text.Font = Library.Font
Text.TextSize = 20
Text.Parent = ToggleButton
